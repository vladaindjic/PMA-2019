...
public class RestaurantsGridAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                return new RestaurantsGridAdapter.ViewHolder(
                        LayoutInflater.from(parent.getContext()).inflate(R.layout.restaurants_grid_item_layout, parent,
                                false));
            case VIEW_TYPE_EMPTY:
            default:
                return new RestaurantsGridAdapter.EmptyViewHolder(
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        @BindView(R.id.restaurants_grid_item_image_view)
        ImageView coverImageView;

        @BindView(R.id.restaurants_grid_item_txt)
...
//                    }
    ...
    public class EmptyViewHolder extends BaseViewHolder {
        ...
        public EmptyViewHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
            messageTextView.setText( " restaurant found, please check filter!");
        }
